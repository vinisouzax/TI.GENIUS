...
<head>
	...
	<script>
        ...
        function adicionaLinha(idTabela) {
        	...
        	celula1.innerHTML = "<input maxlength='50' class='form-control' type='text' id='nmValor"+(numeroLinhas-1)+"' name='nmValor"+(numeroLinhas-1)+"' placeholder='Valor' required>"; 
        ...
        function confirma_excluir(idValor){
        	var apagar = confirm('Você deseja excluir este valor');
        	if (apagar){
        		location.href = '<?php echo base_url("Variaveis/DeleteValor") ?>/'+ idValor;
        	}
        }           
    </script> 
</head>
				...
				<div class="login-wrapper">
					<div class="box">
						<div class="content-wrap">
							<h6>Edição de Variáveis <br><button style="border: none;" type="button" class="btn btn-default btn-lg" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-info-sign"></i> Info</button></h6>
							...
							<div class="modal fade" id="myModal" role="dialog">
								...
								<?php if($nivelAcesso == "Administrador"){
									...
									echo form_open_multipart('Variaveis/UpdateVariavel'); ?>
									<input class="form-control" type="hidden" id="Id" name="Id" value="<?php if($variavel->idVariavel != ''){ echo $variavel->idVariavel;}  ?>">
									<p style="font-size: 14px;"><strong>Nome da Variável</strong></p>
									<input maxlength="50" class="form-control" type="text" id="Nome" name="Nome" value="<?php if($variavel->nmVariavel != ''){ echo $variavel->nmVariavel;}  ?>" placeholder="Nome da Variável" required>
									<br>
									<p style="font-size: 14px;"><strong>Pergunta</strong></p>
									<input maxlength="200" class="form-control" type="text" id="Pergunta" name="Pergunta" value="<?php if($variavel->pergunta != ''){ echo $variavel->pergunta;}  ?>" placeholder="Pergunta para essa variável" >
									<br><br>
										...
										<table class="table" id="tabela" name="tabela">
											...
											<tbody class="col-md-12">
												...
												foreach ($valores as $valor) {
													...
													echo '<td hidden><input class="form-control" type="text" id="idValor' . $i . '" name="idValor' . $i . '" value="' . $valor->idValor . '"></td>';
													echo '<td><input maxlength="50" class="form-control" type="text" id="nmValor' . $i . '" name="nmValor' . $i . '" value="' . $valor->nmValor . '" placeholder="Valor" required></td>';

													echo '<td> <a class="btn btn-danger btn-xs" onclick="confirma_excluir(' . $valor->idValor . ');"
													><i class="glyphicon glyphicon-remove"></i> Remover </a></td>';
													echo '</tr>';
													$i++;
												}
